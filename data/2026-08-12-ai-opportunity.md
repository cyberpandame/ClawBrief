# 商用情报简报 · 2026-08-12（自动抓取实版）

- 刷新时间：2026-08-12 09:49 UTC
...
- openai_news: status=403, latency=115ms HTTP 403
- openai_ads: status=403, latency=105ms HTTP 403
- carb_act: status=202, latency=215ms 
- carb_fact: status=202, latency=145ms 
- daimler: status=200, latency=1005ms 
- torc: status=200, latency=361ms 
