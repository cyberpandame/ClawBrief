# 商用情报简报 · 2026-06-04（自动抓取实版）

- 刷新时间：2026-06-04 11:42 UTC
...
- openai_news: status=403, latency=128ms HTTP 403
- openai_ads: status=403, latency=91ms HTTP 403
- carb_act: status=200, latency=332ms 
- carb_fact: status=200, latency=333ms 
- daimler: status=200, latency=807ms 
- torc: status=200, latency=274ms 
