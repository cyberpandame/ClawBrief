# 商用情报简报 · 2026-06-06（自动抓取实版）

- 刷新时间：2026-06-06 10:47 UTC
...
- openai_ads: status=403, latency=49ms HTTP 403
- carb_act: status=403, latency=234ms HTTP 403
- carb_fact: status=403, latency=104ms HTTP 403
- daimler: status=200, latency=852ms 
- torc: status=200, latency=228ms 
