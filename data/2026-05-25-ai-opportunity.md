# 商用情报简报 · 2026-05-25（自动抓取实版）

- 刷新时间：2026-05-25 12:15 UTC
...
- openai_news: status=403, latency=98ms HTTP 403
- openai_ads: status=403, latency=99ms HTTP 403
- carb_act: status=200, latency=336ms 
- carb_fact: status=200, latency=291ms 
- daimler: status=200, latency=1030ms 
- torc: status=200, latency=336ms 
