# 商用情报简报 · 2026-05-19（自动抓取实版）

- 刷新时间：2026-05-19 11:51 UTC
...
- openai_ads: status=403, latency=46ms HTTP 403
- carb_act: status=200, latency=466ms 
- carb_fact: status=200, latency=465ms 
- daimler: status=200, latency=878ms 
