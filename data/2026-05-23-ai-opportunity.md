# 商用情报简报 · 2026-05-23（自动抓取实版）

- 刷新时间：2026-05-23 10:18 UTC
...
- openai_news: status=403, latency=89ms HTTP 403
- openai_ads: status=403, latency=74ms HTTP 403
- carb_act: status=200, latency=363ms 
- carb_fact: status=200, latency=322ms 
- daimler: status=200, latency=3098ms 
- torc: status=200, latency=259ms 
