# 商用情报简报 · 2026-09-09（自动抓取实版）

- 刷新时间：2026-09-09 13:11 UTC
...
- openai_news: status=403, latency=120ms HTTP 403
- openai_ads: status=403, latency=74ms HTTP 403
- carb_act: status=202, latency=205ms 
- carb_fact: status=202, latency=105ms 
- daimler: status=200, latency=1089ms 
- torc: status=200, latency=311ms 
