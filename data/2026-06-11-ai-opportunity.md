# 商用情报简报 · 2026-06-11（自动抓取实版）

- 刷新时间：2026-06-11 12:34 UTC
...
- openai_news: status=403, latency=49ms HTTP 403
- openai_ads: status=403, latency=44ms HTTP 403
- carb_act: status=403, latency=77ms HTTP 403
- carb_fact: status=403, latency=44ms HTTP 403
- daimler: status=200, latency=14510ms 
- torc: status=200, latency=384ms 
