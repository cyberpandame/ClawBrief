# 商用情报简报 · 2026-08-10（自动抓取实版）

- 刷新时间：2026-08-10 10:05 UTC
...
- openai_ads: status=403, latency=55ms HTTP 403
- carb_act: status=202, latency=172ms 
- carb_fact: status=202, latency=110ms 
- daimler: status=200, latency=1064ms 
- torc: status=200, latency=471ms 
