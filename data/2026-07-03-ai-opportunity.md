# 商用情报简报 · 2026-07-03（自动抓取实版）

- 刷新时间：2026-07-03 11:21 UTC
...
- openai_news: status=403, latency=40ms HTTP 403
- openai_ads: status=403, latency=45ms HTTP 403
- carb_act: status=405, latency=228ms HTTP 405
- carb_fact: status=405, latency=105ms HTTP 405
- daimler: status=200, latency=616ms 
- torc: status=200, latency=147ms 
