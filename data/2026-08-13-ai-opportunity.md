# 商用情报简报 · 2026-08-13（自动抓取实版）

- 刷新时间：2026-08-13 09:50 UTC
...
- openai_news: status=403, latency=52ms HTTP 403
- openai_ads: status=403, latency=59ms HTTP 403
- carb_act: status=202, latency=206ms 
- carb_fact: status=202, latency=103ms 
- daimler: status=200, latency=1061ms 
- torc: status=200, latency=467ms 
