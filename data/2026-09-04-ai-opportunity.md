# 商用情报简报 · 2026-09-04（自动抓取实版）

- 刷新时间：2026-09-04 12:57 UTC
...
- openai_news: status=403, latency=167ms HTTP 403
- openai_ads: status=403, latency=63ms HTTP 403
- carb_act: status=202, latency=226ms 
- carb_fact: status=202, latency=44ms 
- daimler: status=200, latency=653ms 
- torc: status=200, latency=319ms 
