# 商用情报简报 · 2026-06-12（自动抓取实版）

- 刷新时间：2026-06-12 12:09 UTC
...
- carb_act: status=403, latency=74ms HTTP 403
- carb_fact: status=403, latency=42ms HTTP 403
- daimler: status=200, latency=1044ms 
- torc: status=200, latency=451ms 
