# 商用情报简报 · 2026-05-31（自动抓取实版）

- 刷新时间：2026-05-31 10:49 UTC
...
- carb_act: status=200, latency=142ms 
- carb_fact: status=200, latency=134ms 
- daimler: status=200, latency=1076ms 
- torc: status=200, latency=376ms 
