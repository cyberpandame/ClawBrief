# 商用情报简报 · 2026-05-21（自动抓取实版）

- 刷新时间：2026-05-21 11:58 UTC
...
- carb_act: status=200, latency=134ms 
- carb_fact: status=200, latency=135ms 
- daimler: status=200, latency=390ms 
- torc: status=200, latency=386ms 
