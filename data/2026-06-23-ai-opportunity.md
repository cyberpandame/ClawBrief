# 商用情报简报 · 2026-06-23（自动抓取实版）

- 刷新时间：2026-06-23 11:48 UTC
...
- openai_news: status=403, latency=122ms HTTP 403
- openai_ads: status=403, latency=67ms HTTP 403
- carb_act: status=403, latency=166ms HTTP 403
- carb_fact: status=403, latency=76ms HTTP 403
- daimler: status=200, latency=1049ms 
- torc: status=200, latency=490ms 
