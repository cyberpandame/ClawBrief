# 商用情报简报 · 2026-07-28（自动抓取实版）

- 刷新时间：2026-07-28 11:06 UTC
...
- openai_news: status=403, latency=68ms HTTP 403
- openai_ads: status=403, latency=36ms HTTP 403
- carb_act: status=403, latency=157ms HTTP 403
- carb_fact: status=403, latency=61ms HTTP 403
- daimler: status=200, latency=485ms 
- torc: status=200, latency=253ms 
