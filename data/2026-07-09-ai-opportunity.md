# 商用情报简报 · 2026-07-09（自动抓取实版）

- 刷新时间：2026-07-09 11:41 UTC
...
- openai_news: status=403, latency=43ms HTTP 403
- openai_ads: status=403, latency=45ms HTTP 403
- carb_act: status=405, latency=106ms HTTP 405
- carb_fact: status=405, latency=107ms HTTP 405
- daimler: status=200, latency=764ms 
- torc: status=200, latency=242ms 
