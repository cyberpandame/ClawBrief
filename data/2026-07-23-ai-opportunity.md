# 商用情报简报 · 2026-07-23（自动抓取实版）

- 刷新时间：2026-07-23 10:54 UTC
...
- carb_act: status=403, latency=56ms HTTP 403
- carb_fact: status=403, latency=35ms HTTP 403
- daimler: status=200, latency=1020ms 
- torc: status=200, latency=507ms 
