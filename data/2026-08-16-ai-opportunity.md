# 商用情报简报 · 2026-08-16（自动抓取实版）

- 刷新时间：2026-08-16 09:13 UTC
...
- openai_ads: status=403, latency=80ms HTTP 403
- carb_act: status=202, latency=239ms 
- carb_fact: status=202, latency=149ms 
- daimler: status=200, latency=1004ms 
- torc: status=200, latency=403ms 
