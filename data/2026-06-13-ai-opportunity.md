# 商用情报简报 · 2026-06-13（自动抓取实版）

- 刷新时间：2026-06-13 11:05 UTC
...
- openai_news: status=403, latency=80ms HTTP 403
- openai_ads: status=403, latency=58ms HTTP 403
- carb_act: status=403, latency=396ms HTTP 403
- carb_fact: status=403, latency=164ms HTTP 403
- daimler: status=200, latency=1018ms 
- torc: status=200, latency=322ms 
