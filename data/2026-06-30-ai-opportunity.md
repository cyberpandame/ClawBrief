# 商用情报简报 · 2026-06-30（自动抓取实版）

- 刷新时间：2026-06-30 11:36 UTC
...
- openai_news: status=403, latency=46ms HTTP 403
- openai_ads: status=403, latency=44ms HTTP 403
- carb_act: status=405, latency=217ms HTTP 405
- carb_fact: status=405, latency=122ms HTTP 405
- daimler: status=200, latency=739ms 
