# 商用情报简报 · 2026-09-06（自动抓取实版）

- 刷新时间：2026-09-06 12:24 UTC
...
- carb_act: status=202, latency=259ms 
- carb_fact: status=202, latency=45ms 
- daimler: status=200, latency=835ms 
- torc: status=200, latency=289ms 
