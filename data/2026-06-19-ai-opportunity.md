# 商用情报简报 · 2026-06-19（自动抓取实版）

- 刷新时间：2026-06-19 12:38 UTC
...
- carb_act: status=403, latency=178ms HTTP 403
- carb_fact: status=403, latency=87ms HTTP 403
- daimler: status=200, latency=750ms 
