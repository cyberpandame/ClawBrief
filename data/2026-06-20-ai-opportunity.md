# 商用情报简报 · 2026-06-20（自动抓取实版）

- 刷新时间：2026-06-20 11:05 UTC
...
- openai_news: status=403, latency=87ms HTTP 403
- openai_ads: status=403, latency=88ms HTTP 403
- carb_act: status=403, latency=250ms HTTP 403
- carb_fact: status=403, latency=64ms HTTP 403
- daimler: status=200, latency=905ms 
