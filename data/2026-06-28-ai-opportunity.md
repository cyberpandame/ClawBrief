# 商用情报简报 · 2026-06-28（自动抓取实版）

- 刷新时间：2026-06-28 10:56 UTC
...
- openai_news: status=403, latency=79ms HTTP 403
- openai_ads: status=403, latency=76ms HTTP 403
- carb_act: status=405, latency=223ms HTTP 405
- carb_fact: status=405, latency=109ms HTTP 405
- daimler: status=200, latency=817ms 
- torc: status=200, latency=272ms 
