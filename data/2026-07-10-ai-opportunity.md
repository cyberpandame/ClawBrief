# 商用情报简报 · 2026-07-10（自动抓取实版）

- 刷新时间：2026-07-10 11:38 UTC
...
- openai_news: status=403, latency=101ms HTTP 403
- openai_ads: status=403, latency=42ms HTTP 403
- carb_act: status=405, latency=176ms HTTP 405
- carb_fact: status=405, latency=37ms HTTP 405
- daimler: status=200, latency=556ms 
- torc: status=200, latency=251ms 
