# 商用情报简报 · 2026-09-02（自动抓取实版）

- 刷新时间：2026-09-02 13:00 UTC
...
- openai_ads: status=403, latency=99ms HTTP 403
- carb_act: status=202, latency=182ms 
- carb_fact: status=202, latency=77ms 
- daimler: status=200, latency=1020ms 
- torc: status=200, latency=371ms 
