# 商用情报简报 · 2026-07-15（自动抓取实版）

- 刷新时间：2026-07-15 10:30 UTC
...
- carb_act: status=403, latency=55ms HTTP 403
- carb_fact: status=403, latency=44ms HTTP 403
- daimler: status=200, latency=1063ms 
- torc: status=200, latency=429ms 
