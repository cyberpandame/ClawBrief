# 商用情报简报 · 2026-07-21（自动抓取实版）

- 刷新时间：2026-07-21 10:53 UTC
...
- openai_news: status=403, latency=48ms HTTP 403
- openai_ads: status=403, latency=48ms HTTP 403
- carb_act: status=403, latency=92ms HTTP 403
- carb_fact: status=403, latency=111ms HTTP 403
- daimler: status=200, latency=759ms 
- torc: status=200, latency=184ms 
