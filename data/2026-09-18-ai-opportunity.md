# 商用情报简报 · 2026-09-18（自动抓取实版）

- 刷新时间：2026-09-18 13:11 UTC
...
- openai_news: status=403, latency=85ms HTTP 403
- openai_ads: status=403, latency=91ms HTTP 403
- carb_act: status=202, latency=219ms 
- carb_fact: status=202, latency=132ms 
- daimler: status=200, latency=1000ms 
- torc: status=200, latency=414ms 
