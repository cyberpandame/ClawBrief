# 商用情报简报 · 2026-07-16（自动抓取实版）

- 刷新时间：2026-07-16 10:46 UTC
...
- openai_news: status=403, latency=102ms HTTP 403
- openai_ads: status=403, latency=84ms HTTP 403
- carb_act: status=403, latency=249ms HTTP 403
- carb_fact: status=403, latency=133ms HTTP 403
- daimler: status=200, latency=494ms 
- torc: status=200, latency=374ms 
