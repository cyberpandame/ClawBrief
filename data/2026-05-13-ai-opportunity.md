# 商用情报简报 · 2026-05-13（自动抓取实版）

- 刷新时间：2026-05-13 11:21 UTC
...
- openai_news: status=403, latency=118ms HTTP 403
- openai_ads: status=403, latency=57ms HTTP 403
- carb_act: status=200, latency=243ms 
- carb_fact: status=200, latency=214ms 
- daimler: status=200, latency=955ms 
- torc: status=200, latency=417ms 
