# 商用情报简报 · 2026-05-09（自动抓取实版）

- 刷新时间：2026-05-09 09:58 UTC
...
- openai_news: status=200, latency=165ms 
- openai_ads: status=200, latency=319ms 
- carb_act: status=200, latency=365ms 
- carb_fact: status=200, latency=345ms 
