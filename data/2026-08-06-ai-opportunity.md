# 商用情报简报 · 2026-08-06（自动抓取实版）

- 刷新时间：2026-08-06 11:09 UTC
...
- carb_act: status=202, latency=180ms 
- carb_fact: status=202, latency=54ms 
- daimler: status=200, latency=731ms 
- torc: status=200, latency=243ms 
