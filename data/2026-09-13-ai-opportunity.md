# 商用情报简报 · 2026-09-13（自动抓取实版）

- 刷新时间：2026-09-13 13:29 UTC
...
- carb_act: status=202, latency=50ms 
- carb_fact: status=202, latency=34ms 
- daimler: status=200, latency=1094ms 
- torc: status=200, latency=445ms 
