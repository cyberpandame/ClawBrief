# 商用情报简报 · 2026-07-07（自动抓取实版）

- 刷新时间：2026-07-07 11:34 UTC
...
- openai_news: status=403, latency=75ms HTTP 403
- openai_ads: status=403, latency=39ms HTTP 403
- carb_act: status=405, latency=59ms HTTP 405
- carb_fact: status=405, latency=37ms HTTP 405
- daimler: status=200, latency=1054ms 
- torc: status=200, latency=441ms 
