# 商用情报简报 · 2026-05-14（自动抓取实版）

- 刷新时间：2026-05-14 11:05 UTC
...
- openai_ads: status=200, latency=262ms 
- carb_act: status=200, latency=223ms 
- carb_fact: status=200, latency=214ms 
- daimler: status=200, latency=1105ms 
- torc: status=200, latency=421ms 
