# 商用情报简报 · 2026-08-11（自动抓取实版）

- 刷新时间：2026-08-11 09:45 UTC
...
- openai_ads: status=200, latency=575ms 
- carb_act: status=202, latency=136ms 
- carb_fact: status=202, latency=87ms 
- daimler: status=200, latency=569ms 
- torc: status=200, latency=434ms 
