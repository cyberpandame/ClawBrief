# 商用情报简报 · 2026-08-20（自动抓取实版）

- 刷新时间：2026-08-20 09:20 UTC
...
- carb_act: status=202, latency=149ms 
- carb_fact: status=202, latency=88ms 
- daimler: status=200, latency=489ms 
- torc: status=200, latency=300ms 
