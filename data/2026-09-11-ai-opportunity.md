# 商用情报简报 · 2026-09-11（自动抓取实版）

- 刷新时间：2026-09-11 13:02 UTC
...
- openai_news: status=403, latency=93ms HTTP 403
- openai_ads: status=403, latency=90ms HTTP 403
- carb_act: status=202, latency=234ms 
- carb_fact: status=202, latency=127ms 
- daimler: status=200, latency=971ms 
