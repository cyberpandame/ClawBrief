# 商用情报简报 · 2026-07-17（自动抓取实版）

- 刷新时间：2026-07-17 10:27 UTC
...
- openai_ads: status=403, latency=34ms HTTP 403
- carb_act: status=403, latency=76ms HTTP 403
- carb_fact: status=403, latency=45ms HTTP 403
- daimler: status=200, latency=1061ms 
- torc: status=200, latency=606ms 
