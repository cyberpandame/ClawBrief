# 商用情报简报 · 2026-07-08（自动抓取实版）

- 刷新时间：2026-07-08 10:51 UTC
...
- openai_news: status=403, latency=39ms HTTP 403
- openai_ads: status=403, latency=33ms HTTP 403
- carb_act: status=405, latency=247ms HTTP 405
- carb_fact: status=405, latency=115ms HTTP 405
- daimler: status=200, latency=747ms 
- torc: status=200, latency=334ms 
