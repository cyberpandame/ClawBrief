# 商用情报简报 · 2026-05-16（自动抓取实版）

- 刷新时间：2026-05-16 10:05 UTC
...
- openai_news: status=403, latency=69ms HTTP 403
- openai_ads: status=403, latency=44ms HTTP 403
- carb_act: status=200, latency=442ms 
- carb_fact: status=200, latency=461ms 
- daimler: status=200, latency=775ms 
- torc: status=200, latency=240ms 
