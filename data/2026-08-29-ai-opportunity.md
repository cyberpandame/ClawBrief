# 商用情报简报 · 2026-08-29（自动抓取实版）

- 刷新时间：2026-08-29 14:01 UTC
...
- openai_news: status=403, latency=82ms HTTP 403
- openai_ads: status=403, latency=58ms HTTP 403
- carb_act: status=202, latency=163ms 
- carb_fact: status=202, latency=119ms 
- daimler: status=200, latency=744ms 
- torc: status=200, latency=368ms 
