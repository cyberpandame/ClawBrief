# 商用情报简报 · 2026-06-05（自动抓取实版）

- 刷新时间：2026-06-05 11:53 UTC
...
- openai_news: status=403, latency=81ms HTTP 403
- openai_ads: status=403, latency=66ms HTTP 403
- carb_act: status=403, latency=105ms HTTP 403
- carb_fact: status=403, latency=77ms HTTP 403
- daimler: status=200, latency=1162ms 
