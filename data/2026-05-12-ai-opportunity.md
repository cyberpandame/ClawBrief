# 商用情报简报 · 2026-05-12（自动抓取实版）

- 刷新时间：2026-05-12 11:07 UTC
...
- openai_news: status=403, latency=94ms HTTP 403
- openai_ads: status=200, latency=361ms 
- carb_act: status=200, latency=501ms 
- carb_fact: status=200, latency=485ms 
- daimler: status=200, latency=540ms 
