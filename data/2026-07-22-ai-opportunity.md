# 商用情报简报 · 2026-07-22（自动抓取实版）

- 刷新时间：2026-07-22 10:55 UTC
...
- openai_news: status=403, latency=67ms HTTP 403
- openai_ads: status=403, latency=34ms HTTP 403
- carb_act: status=403, latency=81ms HTTP 403
- carb_fact: status=403, latency=45ms HTTP 403
- daimler: status=200, latency=1165ms 
- torc: status=200, latency=440ms 
