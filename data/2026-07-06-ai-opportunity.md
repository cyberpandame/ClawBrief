# 商用情报简报 · 2026-07-06（自动抓取实版）

- 刷新时间：2026-07-06 12:31 UTC
...
- openai_news: status=403, latency=66ms HTTP 403
- openai_ads: status=403, latency=37ms HTTP 403
- carb_act: status=405, latency=139ms HTTP 405
- carb_fact: status=405, latency=32ms HTTP 405
- daimler: status=200, latency=752ms 
- torc: status=200, latency=277ms 
