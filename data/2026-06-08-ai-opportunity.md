# 商用情报简报 · 2026-06-08（自动抓取实版）

- 刷新时间：2026-06-08 12:54 UTC
...
- openai_news: status=403, latency=96ms HTTP 403
- openai_ads: status=403, latency=60ms HTTP 403
- carb_act: status=403, latency=173ms HTTP 403
- carb_fact: status=403, latency=124ms HTTP 403
- daimler: status=200, latency=378ms 
- torc: status=200, latency=432ms 
