# 商用情报简报 · 2026-06-27（自动抓取实版）

- 刷新时间：2026-06-27 10:49 UTC
...
- openai_news: status=403, latency=42ms HTTP 403
- openai_ads: status=403, latency=43ms HTTP 403
- carb_act: status=405, latency=176ms HTTP 405
- carb_fact: status=405, latency=73ms HTTP 405
- daimler: status=200, latency=707ms 
- torc: status=200, latency=234ms 
