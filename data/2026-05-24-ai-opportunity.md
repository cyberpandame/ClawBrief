# 商用情报简报 · 2026-05-24（自动抓取实版）

- 刷新时间：2026-05-24 10:23 UTC
...
- carb_act: status=200, latency=213ms 
- carb_fact: status=200, latency=215ms 
- daimler: status=200, latency=3345ms 
- torc: status=200, latency=446ms 
