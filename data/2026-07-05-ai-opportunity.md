# 商用情报简报 · 2026-07-05（自动抓取实版）

- 刷新时间：2026-07-05 10:54 UTC
...
- openai_news: status=403, latency=51ms HTTP 403
- openai_ads: status=403, latency=51ms HTTP 403
- carb_act: status=405, latency=154ms HTTP 405
- carb_fact: status=405, latency=60ms HTTP 405
- daimler: status=200, latency=774ms 
- torc: status=200, latency=159ms 
