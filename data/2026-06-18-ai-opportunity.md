# 商用情报简报 · 2026-06-18（自动抓取实版）

- 刷新时间：2026-06-18 12:14 UTC
...
- openai_news: status=403, latency=64ms HTTP 403
- openai_ads: status=403, latency=38ms HTTP 403
- carb_act: status=403, latency=167ms HTTP 403
- carb_fact: status=403, latency=95ms HTTP 403
- daimler: status=200, latency=1067ms 
- torc: status=200, latency=395ms 
