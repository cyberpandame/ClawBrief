# 商用情报简报 · 2026-07-18（自动抓取实版）

- 刷新时间：2026-07-18 10:05 UTC
...
- carb_act: status=403, latency=161ms HTTP 403
- carb_fact: status=403, latency=39ms HTTP 403
- daimler: status=200, latency=1034ms 
- torc: status=200, latency=512ms 
