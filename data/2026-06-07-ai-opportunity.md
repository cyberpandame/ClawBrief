# 商用情报简报 · 2026-06-07（自动抓取实版）

- 刷新时间：2026-06-07 10:58 UTC
...
- openai_news: status=403, latency=70ms HTTP 403
- openai_ads: status=403, latency=50ms HTTP 403
- carb_act: status=403, latency=57ms HTTP 403
- carb_fact: status=403, latency=47ms HTTP 403
- daimler: status=200, latency=1055ms 
- torc: status=200, latency=392ms 
