# 商用情报简报 · 2026-08-01（自动抓取实版）

- 刷新时间：2026-08-01 10:23 UTC
...
- carb_act: status=202, latency=80ms 
- carb_fact: status=202, latency=39ms 
- daimler: status=200, latency=1047ms 
- torc: status=200, latency=430ms 
