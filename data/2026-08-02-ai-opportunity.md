# 商用情报简报 · 2026-08-02（自动抓取实版）

- 刷新时间：2026-08-02 10:22 UTC
...
- openai_news: status=403, latency=72ms HTTP 403
- openai_ads: status=403, latency=71ms HTTP 403
- carb_act: status=202, latency=111ms 
- carb_fact: status=202, latency=71ms 
- daimler: status=200, latency=1036ms 
- torc: status=200, latency=439ms 
