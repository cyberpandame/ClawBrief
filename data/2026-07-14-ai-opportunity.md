# 商用情报简报 · 2026-07-14（自动抓取实版）

- 刷新时间：2026-07-14 10:27 UTC
...
- openai_news: status=403, latency=91ms HTTP 403
- openai_ads: status=403, latency=58ms HTTP 403
- carb_act: status=405, latency=158ms HTTP 405
- carb_fact: status=405, latency=142ms HTTP 405
- daimler: status=200, latency=694ms 
- torc: status=200, latency=370ms 
