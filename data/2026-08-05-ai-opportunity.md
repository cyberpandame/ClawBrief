# 商用情报简报 · 2026-08-05（自动抓取实版）

- 刷新时间：2026-08-05 11:09 UTC
...
- openai_news: status=403, latency=57ms HTTP 403
- openai_ads: status=403, latency=43ms HTTP 403
- carb_act: status=202, latency=167ms 
- carb_fact: status=202, latency=4147ms 
- daimler: status=200, latency=532ms 
- torc: status=200, latency=170ms 
