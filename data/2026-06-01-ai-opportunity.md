# 商用情报简报 · 2026-06-01（自动抓取实版）

- 刷新时间：2026-06-01 14:43 UTC
...
- carb_act: status=200, latency=369ms 
- carb_fact: status=200, latency=365ms 
- daimler: status=200, latency=4840ms 
- torc: status=200, latency=151ms 
