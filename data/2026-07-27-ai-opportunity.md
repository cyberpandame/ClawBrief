# 商用情报简报 · 2026-07-27（自动抓取实版）

- 刷新时间：2026-07-27 12:05 UTC
...
- openai_news: status=403, latency=97ms HTTP 403
- openai_ads: status=403, latency=97ms HTTP 403
- carb_act: status=403, latency=262ms HTTP 403
- carb_fact: status=403, latency=76ms HTTP 403
- daimler: status=200, latency=976ms 
- torc: status=200, latency=468ms 
