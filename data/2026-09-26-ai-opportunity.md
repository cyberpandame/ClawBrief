# 商用情报简报 · 2026-09-26（自动抓取实版）

- 刷新时间：2026-09-26 13:24 UTC
...
- openai_news: status=403, latency=92ms HTTP 403
- openai_ads: status=403, latency=45ms HTTP 403
- carb_act: status=202, latency=194ms 
- carb_fact: status=202, latency=101ms 
- daimler: status=200, latency=706ms 
- torc: status=200, latency=250ms 
