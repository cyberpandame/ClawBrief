# 商用情报简报 · 2026-07-20（自动抓取实版）

- 刷新时间：2026-07-20 11:30 UTC
...
- carb_act: status=403, latency=152ms HTTP 403
- carb_fact: status=403, latency=33ms HTTP 403
- daimler: status=200, latency=468ms 
- torc: status=200, latency=310ms 
