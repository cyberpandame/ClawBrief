# 商用情报简报 · 2026-06-22（自动抓取实版）

- 刷新时间：2026-06-22 14:20 UTC
...
- openai_news: status=403, latency=44ms HTTP 403
- openai_ads: status=403, latency=37ms HTTP 403
- carb_act: status=403, latency=67ms HTTP 403
- carb_fact: status=403, latency=35ms HTTP 403
- daimler: status=200, latency=1028ms 
- torc: status=200, latency=383ms 
