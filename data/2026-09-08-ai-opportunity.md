# 商用情报简报 · 2026-09-08（自动抓取实版）

- 刷新时间：2026-09-08 13:06 UTC
...
- openai_news: status=403, latency=84ms HTTP 403
- openai_ads: status=403, latency=62ms HTTP 403
- carb_act: status=202, latency=134ms 
- carb_fact: status=202, latency=97ms 
- daimler: status=200, latency=1131ms 
- torc: status=200, latency=482ms 
