# 商用情报简报 · 2026-05-08（自动抓取实版）

- 刷新时间：2026-05-08 10:12 UTC
...
- openai_ads: status=200, latency=320ms 
- carb_act: status=200, latency=351ms 
- carb_fact: status=200, latency=353ms 
- daimler: status=200, latency=938ms 
- torc: status=200, latency=145ms 
