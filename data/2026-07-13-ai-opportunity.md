# 商用情报简报 · 2026-07-13（自动抓取实版）

- 刷新时间：2026-07-13 11:45 UTC
...
- openai_news: status=403, latency=63ms HTTP 403
- openai_ads: status=403, latency=39ms HTTP 403
- carb_act: status=405, latency=188ms HTTP 405
- carb_fact: status=405, latency=122ms HTTP 405
- daimler: status=200, latency=604ms 
- torc: status=200, latency=335ms 
