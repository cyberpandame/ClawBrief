# 商用情报简报 · 2026-07-04（自动抓取实版）

- 刷新时间：2026-07-04 10:44 UTC
...
- carb_act: status=405, latency=56ms HTTP 405
- carb_fact: status=405, latency=32ms HTTP 405
- daimler: status=200, latency=1041ms 
- torc: status=200, latency=389ms 
