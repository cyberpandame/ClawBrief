# 商用情报简报 · 2026-07-29（自动抓取实版）

- 刷新时间：2026-07-29 11:11 UTC
...
- openai_news: status=403, latency=36ms HTTP 403
- openai_ads: status=403, latency=34ms HTTP 403
- carb_act: status=202, latency=176ms 
- carb_fact: status=202, latency=75ms 
- daimler: status=200, latency=569ms 
- torc: status=200, latency=143ms 
