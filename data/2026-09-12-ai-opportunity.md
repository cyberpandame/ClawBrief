# 商用情报简报 · 2026-09-12（自动抓取实版）

- 刷新时间：2026-09-12 12:25 UTC
...
- openai_ads: status=403, latency=41ms HTTP 403
- carb_act: status=202, latency=121ms 
- carb_fact: status=202, latency=110ms 
- daimler: status=200, latency=842ms 
- torc: status=200, latency=226ms 
