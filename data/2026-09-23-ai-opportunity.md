# 商用情报简报 · 2026-09-23（自动抓取实版）

- 刷新时间：2026-09-23 13:53 UTC
...
- openai_news: status=403, latency=130ms HTTP 403
- openai_ads: status=403, latency=63ms HTTP 403
- carb_act: status=202, latency=107ms 
- carb_fact: status=202, latency=56ms 
- daimler: status=200, latency=1077ms 
- torc: status=200, latency=543ms 
