# 商用情报简报 · 2026-06-29（自动抓取实版）

- 刷新时间：2026-06-29 12:53 UTC
...
- openai_news: status=403, latency=62ms HTTP 403
- openai_ads: status=403, latency=45ms HTTP 403
- carb_act: status=405, latency=63ms HTTP 405
- carb_fact: status=405, latency=43ms HTTP 405
- daimler: status=200, latency=1031ms 
- torc: status=200, latency=479ms 
