# 商用情报简报 · 2026-05-29（自动抓取实版）

- 刷新时间：2026-05-29 11:59 UTC
...
- openai_ads: status=403, latency=65ms HTTP 403
- carb_act: status=200, latency=236ms 
- carb_fact: status=200, latency=223ms 
- daimler: status=200, latency=1108ms 
- torc: status=200, latency=419ms 
