# 商用情报简报 · 2026-05-20（自动抓取实版）

- 刷新时间：2026-05-20 11:39 UTC
...
- openai_news: status=403, latency=99ms HTTP 403
- openai_ads: status=403, latency=82ms HTTP 403
- carb_act: status=200, latency=324ms 
- carb_fact: status=200, latency=327ms 
- daimler: status=200, latency=1039ms 
- torc: status=200, latency=337ms 
