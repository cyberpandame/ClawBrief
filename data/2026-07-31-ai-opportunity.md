# 商用情报简报 · 2026-07-31（自动抓取实版）

- 刷新时间：2026-07-31 11:13 UTC
...
- openai_news: status=403, latency=77ms HTTP 403
- openai_ads: status=403, latency=58ms HTTP 403
- carb_act: status=202, latency=184ms 
- carb_fact: status=202, latency=101ms 
- daimler: status=200, latency=1054ms 
- torc: status=200, latency=625ms 
