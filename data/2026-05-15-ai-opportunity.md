# 商用情报简报 · 2026-05-15（自动抓取实版）

- 刷新时间：2026-05-15 11:08 UTC
...
- openai_news: status=403, latency=54ms HTTP 403
- openai_ads: status=403, latency=50ms HTTP 403
- carb_act: status=200, latency=381ms 
- carb_fact: status=200, latency=411ms 
- daimler: status=200, latency=760ms 
- torc: status=200, latency=297ms 
