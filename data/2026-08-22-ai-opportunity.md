# 商用情报简报 · 2026-08-22（自动抓取实版）

- 刷新时间：2026-08-22 09:13 UTC
...
- openai_ads: status=403, latency=30ms HTTP 403
- carb_act: status=202, latency=44ms 
- carb_fact: status=202, latency=49ms 
- daimler: status=200, latency=1027ms 
- torc: status=200, latency=426ms 
