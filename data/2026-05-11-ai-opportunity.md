# 商用情报简报 · 2026-05-11（自动抓取实版）

- 刷新时间：2026-05-11 11:52 UTC
...
- openai_news: status=403, latency=73ms HTTP 403
- openai_ads: status=403, latency=72ms HTTP 403
- carb_act: status=200, latency=242ms 
- carb_fact: status=200, latency=225ms 
- daimler: status=200, latency=824ms 
- torc: status=200, latency=427ms 
