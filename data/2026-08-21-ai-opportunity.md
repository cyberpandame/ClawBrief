# 商用情报简报 · 2026-08-21（自动抓取实版）

- 刷新时间：2026-08-21 09:21 UTC
...
- carb_act: status=202, latency=151ms 
- carb_fact: status=202, latency=96ms 
- daimler: status=200, latency=1097ms 
- torc: status=200, latency=647ms 
