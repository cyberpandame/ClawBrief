# 商用情报简报 · 2026-09-07（自动抓取实版）

- 刷新时间：2026-09-07 14:29 UTC
...
- openai_news: status=403, latency=53ms HTTP 403
- openai_ads: status=403, latency=62ms HTTP 403
- carb_act: status=202, latency=135ms 
- carb_fact: status=202, latency=55ms 
- daimler: status=200, latency=1126ms 
- torc: status=200, latency=503ms 
