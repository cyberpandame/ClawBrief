# 商用情报简报 · 2026-06-25（自动抓取实版）

- 刷新时间：2026-06-25 11:29 UTC
...
- openai_news: status=403, latency=61ms HTTP 403
- openai_ads: status=403, latency=36ms HTTP 403
- carb_act: status=405, latency=212ms HTTP 405
- carb_fact: status=405, latency=81ms HTTP 405
- daimler: status=200, latency=726ms 
- torc: status=200, latency=229ms 
