# 商用情报简报 · 2026-08-27（自动抓取实版）

- 刷新时间：2026-08-27 19:16 UTC
...
- carb_act: status=202, latency=127ms 
- carb_fact: status=202, latency=85ms 
- daimler: status=200, latency=737ms 
- torc: status=200, latency=326ms 
