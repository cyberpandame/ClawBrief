# 商用情报简报 · 2026-06-03（自动抓取实版）

- 刷新时间：2026-06-03 13:02 UTC
...
- carb_act: status=200, latency=391ms 
- carb_fact: status=200, latency=344ms 
- daimler: status=200, latency=879ms 
- torc: status=200, latency=129ms 
