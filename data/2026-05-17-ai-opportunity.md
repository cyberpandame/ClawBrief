# 商用情报简报 · 2026-05-17（自动抓取实版）

- 刷新时间：2026-05-17 10:14 UTC
...
- openai_ads: status=403, latency=54ms HTTP 403
- carb_act: status=200, latency=529ms 
- carb_fact: status=200, latency=491ms 
- daimler: status=200, latency=738ms 
- torc: status=200, latency=255ms 
