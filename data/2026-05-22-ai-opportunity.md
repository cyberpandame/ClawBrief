# 商用情报简报 · 2026-05-22（自动抓取实版）

- 刷新时间：2026-05-22 11:35 UTC
...
- carb_act: status=200, latency=486ms 
- carb_fact: status=200, latency=488ms 
- daimler: status=200, latency=792ms 
- torc: status=200, latency=244ms 
