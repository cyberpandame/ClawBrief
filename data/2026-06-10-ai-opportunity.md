# 商用情报简报 · 2026-06-10（自动抓取实版）

- 刷新时间：2026-06-10 12:10 UTC
...
- openai_news: status=403, latency=60ms HTTP 403
- openai_ads: status=403, latency=312ms HTTP 403
- carb_act: status=403, latency=273ms HTTP 403
- carb_fact: status=403, latency=138ms HTTP 403
- daimler: status=200, latency=723ms 
- torc: status=200, latency=537ms 
