# 商用情报简报 · 2026-09-05（自动抓取实版）

- 刷新时间：2026-09-05 12:08 UTC
...
- openai_news: status=403, latency=76ms HTTP 403
- openai_ads: status=403, latency=92ms HTTP 403
- carb_act: status=202, latency=223ms 
- carb_fact: status=202, latency=110ms 
- daimler: status=200, latency=1024ms 
- torc: status=200, latency=279ms 
