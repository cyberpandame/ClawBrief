# 商用情报简报 · 2026-06-14（自动抓取实版）

- 刷新时间：2026-06-14 11:20 UTC
...
- carb_act: status=403, latency=61ms HTTP 403
- carb_fact: status=403, latency=58ms HTTP 403
- daimler: status=200, latency=1023ms 
