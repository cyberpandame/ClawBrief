# 商用情报简报 · 2026-08-31（自动抓取实版）

- 刷新时间：2026-08-31 16:25 UTC
...
- openai_ads: status=403, latency=64ms HTTP 403
- carb_act: status=202, latency=197ms 
- carb_fact: status=202, latency=114ms 
- daimler: status=200, latency=836ms 
- torc: status=200, latency=321ms 
