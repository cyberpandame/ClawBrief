# 商用情报简报 · 2026-08-17（自动抓取实版）

- 刷新时间：2026-08-17 09:25 UTC
...
- openai_ads: status=403, latency=68ms HTTP 403
- carb_act: status=202, latency=91ms 
- carb_fact: status=202, latency=37ms 
- daimler: status=200, latency=1059ms 
- torc: status=200, latency=481ms 
