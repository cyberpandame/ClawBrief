# 商用情报简报 · 2026-06-26（自动抓取实版）

- 刷新时间：2026-06-26 11:35 UTC
...
- openai_news: status=403, latency=41ms HTTP 403
- openai_ads: status=403, latency=50ms HTTP 403
- carb_act: status=405, latency=113ms HTTP 405
- carb_fact: status=405, latency=83ms HTTP 405
- daimler: status=200, latency=777ms 
- torc: status=200, latency=137ms 
