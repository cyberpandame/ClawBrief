# 商用情报简报 · 2026-08-07（自动抓取实版）

- 刷新时间：2026-08-07 09:45 UTC
...
- openai_news: status=403, latency=59ms HTTP 403
- openai_ads: status=403, latency=50ms HTTP 403
- carb_act: status=202, latency=141ms 
- carb_fact: status=202, latency=91ms 
- daimler: status=200, latency=624ms 
- torc: status=200, latency=498ms 
