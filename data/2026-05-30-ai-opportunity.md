# 商用情报简报 · 2026-05-30（自动抓取实版）

- 刷新时间：2026-05-30 10:30 UTC
...
- openai_ads: status=403, latency=71ms HTTP 403
- carb_act: status=200, latency=330ms 
- carb_fact: status=200, latency=330ms 
- daimler: status=200, latency=537ms 
- torc: status=200, latency=219ms 
