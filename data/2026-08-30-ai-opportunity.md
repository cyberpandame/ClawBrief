# 商用情报简报 · 2026-08-30（自动抓取实版）

- 刷新时间：2026-08-30 14:00 UTC
...
- openai_news: status=403, latency=105ms HTTP 403
- openai_ads: status=403, latency=101ms HTTP 403
- carb_act: status=202, latency=204ms 
- carb_fact: status=202, latency=113ms 
- daimler: status=200, latency=855ms 
- torc: status=200, latency=309ms 
