# 商用情报简报 · 2026-06-16（自动抓取实版）

- 刷新时间：2026-06-16 13:19 UTC
...
- openai_news: status=403, latency=197ms HTTP 403
- openai_ads: status=403, latency=111ms HTTP 403
- carb_act: status=403, latency=242ms HTTP 403
- carb_fact: status=403, latency=129ms HTTP 403
- daimler: status=200, latency=992ms 
- torc: status=200, latency=329ms 
