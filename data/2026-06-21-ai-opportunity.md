# 商用情报简报 · 2026-06-21（自动抓取实版）

- 刷新时间：2026-06-21 11:36 UTC
...
- openai_news: status=403, latency=47ms HTTP 403
- openai_ads: status=403, latency=40ms HTTP 403
- carb_act: status=403, latency=372ms HTTP 403
- carb_fact: status=403, latency=258ms HTTP 403
- daimler: status=200, latency=458ms 
- torc: status=200, latency=227ms 
