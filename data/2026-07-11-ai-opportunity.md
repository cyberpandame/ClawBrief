# 商用情报简报 · 2026-07-11（自动抓取实版）

- 刷新时间：2026-07-11 10:06 UTC
...
- openai_ads: status=403, latency=42ms HTTP 403
- carb_act: status=405, latency=185ms HTTP 405
- carb_fact: status=405, latency=117ms HTTP 405
- daimler: status=200, latency=412ms 
- torc: status=200, latency=377ms 
